...
public class WinScreen extends AbstractScreen {
	...
	public WinScreen(LD29Game game, GameScreen parent) {
		super(game);
		this.parent = parent;
		create();
	}
	...
	public void create() {
		...
		table.row().left();
		table.add(new Label("Health: " + game.player.getHealth(), skin));
		table.row().left();
		table.add(new Label("Start again or return to the menu",
				skin));
		...
		final TextButton tryAgainButton = new TextButton("Start Again", skin);
		// menuButton.setPosition(Gdx.graphics.getWidth()/2 - 250, 50);
